...
function verifySources() { var v = _settings && _settings.verifySources; return v !== false && v !== "false" && v !== 0 && v !== "0"; }
...
function hardenSrc(c, s, reresolve) {
    ...
    log("    verificar: fuente descartada (sigue caida tras reintentos)");
    return null;
}
